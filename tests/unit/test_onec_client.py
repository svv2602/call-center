...
class TestOneCClientRequests:
    ...
    async def test_get_wares_full_with_limit(self, onec_client: OneCClient) -> None:
        with patch.object(onec_client, "_get", new_callable=AsyncMock, return_value={"success": True, "data": []}) as mock_get:
    ...
    async def test_confirm_wares_receipt(self, onec_client: OneCClient) -> None:
        with patch.object(onec_client, "_get", new_callable=AsyncMock, return_value={"success": True}) as mock_get:
