...
`search_tires`, `check_availability`, `transfer_to_operator`, `get_order_status`, `create_order_draft`, `update_order_delivery`, `confirm_order`, `get_fitting_stations`, `get_fitting_slots`, `book_fitting`, `search_knowledge_base`
