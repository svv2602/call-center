...
**Задача:** streaming-распознавание речи на украинском и русском языках в реальном времени.
...
config = cloud_speech.StreamingRecognitionConfig(
    config=cloud_speech.RecognitionConfig(
        ...
        alternative_language_codes=["ru-RU"],     # русский как альтернативный
        model="latest_long",
...
> **Почему мультиязычность критична:** Большинство клиентов в Украине говорят
> на суржике (смесь украинского и русского), переключаются между языками
> внутри одного предложения или целиком говорят по-русски. Без поддержки
> русского STT будет плохо распознавать до 30–40% обращений.
...
- `alternative_language_codes=["ru-RU"]` — Google STT автоматически определяет язык каждой фразы
- Обработка `is_final=True` — отправляем финальный текст в LLM (вместе с detected language)
- Обработка пауз (VAD) — определение конца фразы клиента
- Таймаут тишины: 10 секунд → "Ви ще на лінії?"
- В каждом final transcript приходит `language_code` — логируем для аналитики
...
або суржиком. Ти розумієш і українську, і російську мову без проблем.
...
- Якщо клієнт говорить російською — розумій його, але відповідай українською
```
