...
│
├── audit-report.md                    # [Исторический] Первоначальный аудит (рекомендации реализованы)
├── audit-improvement-suggestions.md   # [Исторический] Второй аудит (рекомендации реализованы)
├── doc-audit-2026-02-13.md            # Третий аудит: несостыковки, инструменты, API, эксплуатация
│
└── development/                       # Документация для разработки
    ├── 00-overview.md                 # Общий обзор, стек, тестирование, CI/CD
    ├── phase-1-mvp.md                 # Фаза 1: подбор шин, наличие, мультиязычный STT
    ...
    ├── deployment-checklist.md        # Чек-лист перед запуском в продакшен
    ├── setup-local.md                 # Настройка локальной среды разработки
    ├── troubleshooting.md             # Решение типичных проблем
    └── glossary.md                    # Глоссарий терминов (телефония, AI, архитектура)
```
