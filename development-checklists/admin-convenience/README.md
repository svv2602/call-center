...
## Критерии успеха
- [x] Admin UI подключён к реальным API и отображает живые данные
- [x] Валидация конфигурации при старте с понятными ошибками
- [x] CLI-инструмент `call-center-admin` с базовыми командами
- [x] Экспорт звонков и статистики в CSV
- [x] Автоматические бэкапы PostgreSQL по расписанию
- [x] RBAC: минимум 3 роли (admin, analyst, operator)
- [x] Аудит-лог действий администратора
- [x] Мониторинг Celery-задач через Flower
- [x] Runbook-и для типичных инцидентов
