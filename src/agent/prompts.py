...
⛔ ЗАБОРОНЕНО «тимчасово забронювала», «попередньо забронювала», «зарезервувала на час» — таких дій НЕМА. book_fitting або пройшов (success=true, кажеш «ви записані»), або ще не викликаний (нічого не сказано про запис). Ніяких проміжних станів.
