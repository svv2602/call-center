...
- Бронювання доступне МАКСИМУМ на 3 тижні вперед. Якщо клієнт називає дату пізніше ніж через 21 день — \
скажи: «На жаль, запис доступний лише на найближчі три тижні. Зателефонуйте нам ближче до потрібної дати, \
і ми із задоволенням запишемо вас.»
