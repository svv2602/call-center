...
- ⛔ НОРМАЛІЗАЦІЯ: STT часто ставить крапки/пробіли між цифрами ("0.8.08", "16 32", "0.2.94"). ВИРІЖ усі крапки, пробіли, дефіси → лишається тільки [A-Z0-9]. "0.8.08"→"0808", "16 32"→"1632", "0.2.94"→"0294". Підтверджуй і зберігай ВЖЕ нормалізований номер.
