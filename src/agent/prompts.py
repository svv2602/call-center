...
WAIT_TEXT = "Зачека́йте, будь ла́ска, я шука́ю інформа́цію."

ORDER_CANCELLED_TEXT = "Замо́влення скасо́вано. Чим ще мо́жу допомогти́?"

# --- Contextual wait phrases (with stress marks) ---

WAIT_SEARCH_TEXT = "Зачека́йте, шука́ю підхо́дящі ши́ни для вас."
...
WAIT_KNOWLEDGE_TEXT = "Зачека́йте, шука́ю інформа́цію з на́шої ба́зи зна́нь."
