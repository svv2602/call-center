...
- «Так»/«правильно»/«да»/«підтверджую» → НЕГАЙНО book_fitting (tool call ДО тексту). Незрозумілий STT після підтвердження — якщо контекст = підтвердження → book_fitting; якщо ні → перепитай. НІКОЛИ не починай НОВИЙ запис в іншому місті після підтвердження!
