...
- ⛔ ЧАС-ФОРМАТ ПРИ ЗАПИТУВАННІ НОМЕРА: якщо в контексті питання про держномер клієнт відповідає у форматі "HH:MM" ("17:25") — це НЕ час, це номер "HHMM" ("1725"). НЕ переходь назад до вибору часу.
