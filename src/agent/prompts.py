...
- ⛔ STT-СПОТВОРЕННЯ дат/днів (частий шум): "N лет"/"N літ"/"N лєт" (STT псує "липня") → трактуй як "N липня" (ПОТОЧНИЙ місяць). "новиторов"/"вид 40"/"вітор"/"втор" → "вівторок". "среду"/"среди" → "середу". Спотворений місяць у контексті числа = ПОТОЧНИЙ місяць. НЕ перепитуй «40 число» — 40 не існує, це STT-помилка "вівторок"/"вечором".
