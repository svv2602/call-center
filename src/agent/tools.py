...
FITTING_TOOLS: list[dict] = [  # type: ignore[type-arg]
    ...
    },
    {
        ...
        "description": (
            "Пошук по базі знань магазину. Використовуй для БУДЬ-ЯКИХ питань клієнта, "
            "на які ти не знаєш точної відповіді: акції, знижки, спецпропозиції, умови доставки, "
            "способи оплати, повернення товару, гарантія, юридична інформація, реквізити продавця, "
            "профілі брендів, порівняння, рекомендації, FAQ, гайди. "
            "МОЖНА викликати КІЛЬКА РАЗІВ з різними запитами та категоріями. "
            "Категорії: 'promotions' — акції, знижки, спецпропозиції; "
            "'general' — контакти, про компанію; "
            "'policies' — оферта, юридичні умови, реквізити; "
            "'delivery' — доставка, оплата; 'returns' — повернення; "
            "'warranty' — гарантія; 'brands' — профілі брендів; "
            "'comparisons' — порівняння; 'faq' — часті питання; 'guides' — гайди."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
