...
FITTING_TOOLS: list[dict] = [  # type: ignore[type-arg]
    ...
    },
    {
        ...
        "description": (
            "Пошук по базі знань магазину (профілі брендів, порівняння, рекомендації, FAQ, гайди). "
            "Використовуй для експертних консультацій та складних питань клієнтів. "
            "МОЖНА викликати КІЛЬКА РАЗІВ з різними запитами — наприклад, для порівняння двох "
            "брендів виклич двічі з category='brands' для кожного бренду окремо, потім зіставити. "
            "Використовуй category для точнішого пошуку: 'brands' — профілі брендів, "
