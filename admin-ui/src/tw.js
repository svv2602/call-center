...
// --- Buttons ---
const _btn = 'inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium rounded-md transition-colors cursor-pointer';
...
// --- Filters ---
export const filterBar = 'flex flex-wrap items-center gap-2 mb-4';
...
// --- Modal ---
export const modalClose = 'float-right cursor-pointer text-lg text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-200 transition-colors leading-none';
...
export const tabBtn = 'px-4 py-2 text-sm text-neutral-500 dark:text-neutral-400 border-b-2 border-transparent -mb-px cursor-pointer transition-colors hover:text-neutral-700 dark:hover:text-neutral-200';
