export default {
    ...
    // STT Phrase Hints
    'settings.sttHintsTitle': 'STT Phrase Hints',
    'settings.sttHintsDesc': 'Speech recognition hints: tire brands, catalog models, custom terms. Improves Google STT accuracy.',
    'settings.sttHintsLoadConfig': 'Load STT Hints',
    'settings.sttHintsBase': 'Base',
    'settings.sttHintsAuto': 'From catalog',
    'settings.sttHintsCustom': 'Custom',
    'settings.sttHintsTotal': 'Total',
    'settings.sttHintsLastSync': 'Last sync',
    'settings.sttHintsNeverSynced': 'never',
    'settings.sttHintsCustomLabel': 'Custom phrases (one per line)',
    'settings.sttHintsCustomPlaceholder': 'Enter phrases, one per line...',
    'settings.sttHintsCustomHint': 'Max 1000 phrases, up to 200 chars each. Cyrillic variants of Latin words are most effective.',
    'settings.sttHintsRefresh': 'Refresh from catalog',
    'settings.sttHintsReset': 'Reset',
    'settings.sttHintsResetConfirm': 'Reset STT hints? Only base phrases (brands) will remain.',
    'settings.sttHintsSaved': 'Custom phrases saved ({count})',
    'settings.sttHintsSaveFailed': 'Save failed: {error}',
    'settings.sttHintsRefreshing': 'Refreshing hints from catalog...',
    'settings.sttHintsRefreshed': 'Hints refreshed from catalog',
    'settings.sttHintsRefreshFailed': 'Refresh failed: {error}',
    'settings.sttHintsResetDone': 'STT hints reset to base only',
    'settings.sttHintsLoadFailed': 'Failed to load STT hints: {error}',
    ...
    'help.configuration.sttHints.title': 'STT Phrase Hints',
    'help.configuration.sttHints.content': '<p>Phrase hints system to improve Google STT speech recognition. Three levels:</p><ul><li><strong>Base</strong> — tire brands with Cyrillic pronunciations (Michelin → Мішлен), tire terms</li><li><strong>From catalog</strong> — auto-extracted from tire DB (manufacturers + models) with Latin→Cyrillic transliteration</li><li><strong>Custom</strong> — manually added phrases</li></ul><p>Google API limit: 5000 phrases. Cyrillic variants are most effective since STT for uk-UA outputs Cyrillic text.</p>',
    'help.configuration.sttHints.steps': 'Step-by-step: STT Setup',
    'help.configuration.sttHints.stepsContent': '<ol><li>Open the "STT Phrase Hints" section on the Configuration page</li><li>Click "Refresh from catalog" to extract brands/models from DB</li><li>Check stats: base + auto + custom ≤ 5000</li><li>Add custom phrases (one per line) and click "Save"</li><li>Hints are applied to new calls automatically</li></ol>',
